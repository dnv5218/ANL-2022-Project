...
a_experiment = "agents.experiment_agent2.experiment_agent2.ExperimentAgent2"
#available agents:
...
a_experiment1 = "agents.experiment_agent.experiment_agent.ExperimentAgent"

agents = [a_boulware, a_conceder, a_hardliner, a_linear, a_random, a_experiment1]
names = ["Boulware", "Conceder", "Hardliner", "Linear", "Random", "Experiment1"]
